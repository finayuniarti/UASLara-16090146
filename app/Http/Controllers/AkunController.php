...
class AkunController extends Controller
{
    ...
    {
      $akun_list = User::all();
      return view('sadmin/akun/index', compact('akun_list'));
    }

    public function create()
    {
        return view('sadmin/akun/create');
    }
    ...
    public function store(Request $request)
    {
      ...
      if($validasi->fails()) {
        return redirect('sadmin/akun/create')
        ->withInput()
        ->withErrors($validasi);
      }
    ...
    public function edit($id)
    {
        ...
        return view('sadmin/akun/edit', compact('akun'));
    }
    ...
    public function update($id, Request $request)
    {
        ...
        if($validasi->fails()) {
          return redirect("sadmin/akun/$id/edit")
          ->withErrors($validasi)
          ->withInput();
        }
