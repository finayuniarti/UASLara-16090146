                ...
                <ul class="nav nav-list">
                    ...
                    <li class="ripple">
                      ...
                      <ul class="nav nav-list tree">
                        <li><a href="topnav.html">ICT</a></li>
                        <li><a href="boxed.html">CM</a></li>
                      </ul>
                    </li>
                    <li class="ripple"><a class="tree-toggle nav-header">
                    <span class="fa fa-pencil-square"></span> Item  <span class="fa-angle-right fa right-arrow text-right"></span> </a>
                      <ul class="nav nav-list tree">
                        <li><a href="color.html">ICT</a></li>
                        <li><a href="weather.html">Item</a></li>
                      </ul>
                    </li>
